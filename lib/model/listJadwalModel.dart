...
//
//     final listWaktuModel = listWaktuModelFromJson(jsonString);

import 'dart:convert';

ListWaktuModel listWaktuModelFromJson(String str) =>
    ListWaktuModel.fromJson(json.decode(str));

String listWaktuModelToJson(ListWaktuModel data) => json.encode(data.toJson());

class ListWaktuModel {
  ListWaktuModel({
    this.code,
    this.status,
    this.results,
  ...
  factory ListWaktuModel.fromJson(Map<String, dynamic> json) => ListWaktuModel(
        code: json["code"],
        status: json["status"],
