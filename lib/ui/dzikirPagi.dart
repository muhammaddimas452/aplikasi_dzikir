...
class ZikirPagi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 10, left: 5, bottom: 10, right: 5),
                            margin: EdgeInsets.all(5.0),
                            child: Text('Membaca (Dzikir Pagi dibaca 1x)',
                                style: TextStyle(
                                    color: Colors.black87,
                                    fontWeight: FontWeight.bold)),
                          ),
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 10, left: 5, bottom: 10, right: 5),
                            margin: EdgeInsets.all(5.0),
                            child: Text('Membaca (Dibaca Pagi dan Sore 3x)',
                                style: TextStyle(
                                    color: Colors.black87,
                                    fontWeight: FontWeight.bold)),
                          ),
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 10, left: 5, bottom: 10, right: 5),
                            margin: EdgeInsets.all(5.0),
                            child: Text('Membaca (Dibaca Pagi dan Sore 1x)',
                                style: TextStyle(
                                    color: Colors.black87,
                                    fontWeight: FontWeight.bold)),
                          ),
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        padding: EdgeInsets.only(
                            top: 10, left: 5, bottom: 10, right: 5),
                        margin: EdgeInsets.all(5.0),
                        child: Text('Membaca (Dibaca setiap hari 10x atau 1x)',
                            style: TextStyle(
                                color: Colors.black87,
                                fontWeight: FontWeight.bold)),
                      ),
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        padding: EdgeInsets.only(
                            top: 10, left: 5, bottom: 10, right: 5),
                        margin: EdgeInsets.all(5.0),
                        child: Text('Membaca (Dzikir Pagi dibaca 3x)',
                            style: TextStyle(
                                color: Colors.black87,
                                fontWeight: FontWeight.bold)),
                      ),
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        padding: EdgeInsets.only(
                            top: 10, left: 5, bottom: 10, right: 5),
                        margin: EdgeInsets.all(5.0),
                        child: Text('Membaca (Dibaca Pagi dan Sore 100x)',
                            style: TextStyle(
                                color: Colors.black87,
                                fontWeight: FontWeight.bold)),
                      ),
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        padding: EdgeInsets.only(
                            top: 10, left: 5, bottom: 10, right: 5),
                        margin: EdgeInsets.all(5.0),
                        child: Text('Membaca (Dibaca setiap hari 100x)',
                            style: TextStyle(
                                color: Colors.black87,
                                fontWeight: FontWeight.bold)),
                      ),
                      Container(
                        ...
                        padding: EdgeInsets.only(
                            top: 10, left: 10, bottom: 10, right: 10),
                        margin: EdgeInsets.all(5.0),
                        child: Text('أَسْتَغْفِرُ اللهَ وَأَتُوْبُ إِلَيْهِ',
                            style: TextStyle()),
                      ),
                      Container(
                        decoration: const BoxDecoration(
      ...
      //        child: Image.network('https://yufidia.com/wp-content/uploads/2019/06/Dzikir-Pagi-Memohon-Kebaikan-V3.png', width:1000),
      //      ),
      //      Container(
      //        child: Image.network('https://yufidia.com/wp-content/uploads/2019/06/Dzikir-Pagi-Memohon-Kebaikan-V1.png', width:1000),
      //      ),
      //      Container(
